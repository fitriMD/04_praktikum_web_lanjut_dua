...
<div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="text-align:center">Halo Fila's Lovers, silahkan pesan menu favorit kalian. Nikmati hari - hari penuh canda tawa kalian
                                                      dengan spesial menu dari Fila's Cafe. Jangan lewatkan juga promo - promo menarik dari kami. Pastikan kalian juga stay tune dengan
                                                      informasi yang diberikan oleh Fila's Cafe melalui sosmed. Jika kalian butuh positif vibes yuk datang aja ke <span class="gold-text"> FILA'S CAFE.</span> Kami tunggu yaaa
                                                      <span class="gold-text"> HAVE A NICE DAY!</span>
    ...
    <section class="tm-section row">
        ...
        <section class="tm-section">
          <div class="row">
            <div class="col-lg-12 tm-section-header-container">
              <h2 class="tm-section-header gold-text tm-handwriting-font"><img src="img/logo.png" alt="Logo" class="tm-site-logo"> Quotes</h2> 
              <div class="tm-hr-container"><hr class="tm-hr"></div> 
            </div>  
          </div>          
          <div class="row">
            <div class="tm-daily-menu-container margin-top-60">
              ...
              <div class="col-lg-8 col-md-8"> 
                <p> <span class="white-text"><b>Percayalah dari kegagalan kamu akan tau betapa pentingnya sebuah usaha dan doa.</b></span></p>
              </div>
            </div>
          </div>          
        </section>
