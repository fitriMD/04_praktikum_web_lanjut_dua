...
@section('content')
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="align-text:center">Ada kabar gembira nihhhh, Fila's Cafe akan memberikan informasi terkait menu - menu yang menjadi favorit
                                                      minggu ini, yang lebih spesial lagi untuk menu-menu favorit ini akan dijual dengan diskon 5% dari harga normal.<a href="#main" class="tm-more-button tm-more-button-welcome">Read More</a>      
        </div>
          ...
          <div class="row">
            <div class="tm-daily-menu-container margin-top-60">
              ...
              <p>YEAY!! HARI INI Kalian masih bisa nikmati Promo Tahun baru Fila Cafe dengan harga spesial mulai dari Rp. 27.273,-<br><br>
                ...
                <p>Jika Kalian membutuhkan informasi lebih terkait daftar menu yang tersedia di Fila's Cafe, Fila's Cafe bisa 
                   mendapatkan informasi lengkap hanya dengan klik button dibawah. Yuk buruan dikepoin yaaa!</p>
